...
class WeDevs_Settings_API_Test {
    ...
    function admin_menu() {
        add_options_page( 'Settings API', 'Settings API', 'delete_posts', 'setting_options', array($this, 'plugin_page') );
    }
        ...
        $settings_fields = array(
            ...
            'wedevs_new' => array(
                array(
                    ...
                    'desc'    => __( 'Write your message here...', 'wedevs' ),
                    'type'    => 'textarea',
                    'default' => ''
                )
            )
